...
function simulerRetraits() {
    const retraits = [
        "Oumar Thiam a retiré 4 200 000 HTG 🎉✨",
        "Binta Sow a retiré 2 300 000 HTG 🎉✨",
        "Fatou Diop a retiré 3 500 000 FCFA 🎉✨",
        "Mamadou Kone a retiré 36 500 000 GNF 🎉✨",
        "Bicici Maiga a retiré 4 200 000 FCFA 🎉✨",
        "Ibrahim Maye a retiré 10 200 000 HTG 🎉✨",
        "Cedric Ndoumbe a retiré 8 200 000 HTG 🎉✨",
...
document.getElementById('vendre-btn').addEventListener('click', () => {
    if (solde === 0) {
        ...
        alert(`Vente de ${montant} HTG effectuée.`);
    }
});
